...
function Home() {
  return (
    <div>
        <Image src="/Logo Individuo Social.svg"  alt="me"   width="195"  height="70" />
        <Image src="/whatsapp.svg"  alt="me"   width="26"  height="26" />
        <Image src="/facebook.svg"  alt="me"   width="26"  height="26" />
